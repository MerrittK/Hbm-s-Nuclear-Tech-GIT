...
public class HbmWorldGen implements IWorldGenerator {
	...
	private void generateSurface(World world, Random rand, int i, int j) {
		...
		if(WorldConfig.overworldOre) {
			...
			DepthDeposit.generateConditionOverworld(world, i, 0, 3, j, 5, 0.6D, ModBlocks.cluster_depth_rutile, rand, 32);
			...
			DungeonToolbox.generateOre(world, rand, i, j, WorldConfig.titaniumSpawn, 6, 5, 30, ModBlocks.ore_rutile);
